...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$inputObj->SetAppid(WxPayConfig::get_appid());//公众账号ID
		$inputObj->SetMch_id(WxPayConfig::get_mchid());//商户号
	...
	{		
		...
		$ua = "WXPaySDK/0.9 (".PHP_OS.") PHP/".PHP_VERSION." CURL/".$curlVersion['version']." ".WxPayConfig::get_mchid();
